class AppError extends Error {
  constructor(m, c, code = null) { super(m); this.statusCode = c; this.code = code; this.status = `${c}`.startsWith('4') ? 'fail' : 'error'; this.isOperational = true; Error.captureStackTrace(this, this.constructor); }
}
